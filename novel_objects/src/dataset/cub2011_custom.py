...
class CustomCub2011(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return img, target, self.uq_idxs[idx], raw_img
...
def get_cub_datasets(cub_root, train_transform, test_transform, train_classes=range(160), prop_train_labels=0.8,
...
if __name__ == '__main__':
    cub_root = '../../data'
    x = get_cub_datasets(cub_root, None, None, split_train_val=False,
